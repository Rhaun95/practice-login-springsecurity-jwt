    ...
    return (
        <div className='form'>
            ...
            <form className='login-form' onSubmit={(e) => onUpdate(e)}>
                ...
                <button onClick={() => updateUser(userInfo)} type='submit' className='btn btn--form btn-login'>정보 수정</button>
                <button onClick={() => deleteUser(userInfo.userId)} type='submit' className='btn btn--form btn-login'>회원 탈퇴</button>
